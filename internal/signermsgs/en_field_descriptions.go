...
var (
	...
	ABIEntryInputs          = ffm("EthABIEntry.inputs", "Array of ABI parameter definitions for inputs to a function, or the fields of an event")
	ABIEntryOutputs         = ffm("EthABIEntry.outputs", "Array of ABI parameter definitions for return values from a function")
