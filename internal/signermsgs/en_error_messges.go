...
var (
	...
	MsgEIP712UnknownABICompType    = ffe("FF22066", "Unknown ABI component type: %s")
	MsgNotElementary               = ffe("FF22067", "Not elementary type: %s")
	...
	MsgEIP712TypeNotFound          = ffe("FF22078", "Type '%s' not found in type map")
)
