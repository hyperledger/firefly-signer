...
func TestParseOutputMixedTypesOk(t *testing.T) {
	...
	values := []interface{}{
		...
		ethtypes.MustNewAddress("ab1257528b3782fb40d7ed5f72e624b744dffb2f"),
		[]string{"Ethereum", "Hello, Ethereum!"},
		false,
	}

	tct, err := outputs.TypeComponentTree()
	assert.NoError(t, err)
	...
	assert.Equal(t, "", hex.EncodeToString(enc))

	cv, err := outputs.DecodeABIData(enc, 0)
	assert.NoError(t, err)
